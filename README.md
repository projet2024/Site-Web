<html>
    <head>
        <title>Mon site de tourisme</title>
        <meta charset="utf-8">
        <link rel="stylesheet" href="style.css">
    </head>
    <header>
        <h2 class="accueil dest">Nos destinations de reve</h2>
        <p class="lien">
            <a href="index.html" class="accueil space">Accueil</a>
            <a href="tokyo.html" class="accueil space">Tokyo</a>
            <a href="Hong_Kong.html" class="accueil space">Hong-Kong</a>
            <a href="Dubai.html" class="accueil space">Dubai</a>
            <a href="new_york.html" class="accueil space">New York</a>
            <a href="Londre.html" class="accueil space">Londre</a>
        </p>
    </header>
    <!--debut portfolio-->
    <body>
        <div style="text-align: center;">
            <h1>Presentation generale</h1>
            <h2>
                <p>Bienvenue dans notre site 
            </p>
        </h2>
        </div>
        <div>
            <p>
                <img src="https://www.reunipool.re/wp-content/uploads/2018/03/bienvenue.jpg" class="img-taille" style="block-size: 700px; inline-size: 1250px;margin: inline start 10px;"">
            </p>
        </div>
        <!--fin portfolio-->
        <!--debut presentation-->
        <div>
                ...
                <div class="affichage">
                    <div>
                    <P>
                        <h3> Située autour de la baie éponyme, Tokyo est également la ville la plus visitée des touristes en voyage au Japon,
                        ce qui paraît logique vue la fascination qu'elle procure par son grand écart permanent entre effusions électriques et charme
                         de ses mille villages.Elle accueillait ainsi 13,8 millions de visiteurs étrangers en 2017,
                          plus de deux fois plus qu'en 2017.On apprenait également qu'en 2018,
                           Tokyo recevait 53% des dépenses totales effectuées par les touristes étrangers en visite au Japon !
                         Dans le tiercé de tête à l'échelle nationale : Shibuya, Minato puis Chiyoda.
                         Poumon économique de l'archipel japonais, Tokyo n'en oublie pas d'offrir une variété de paysages hallucinante à quelques encablures
                          et dans toutes les directions : de la mer à la montagne, de la randonnée à l'infinité bétonnée,
                           de sa modernité la plus vaste à (parfois aussi) sa vétusté délicieuse.</h3>
                            <img src="https://plus.unsplash.com/premium_photo-1661914240950-b0124f20a5c1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="img-taille" style="block-size: 600px; inline-size: 1250px;margin: inline start 10px;">
                        </p>
                </div>
            </div>
            <div>
                ...
                <div class="affichage">
                    <div>
                    <P>
                        <h3> Hong Kong, quel archipel formidable ! L’île aux eaux parfumées a parfaitement su allier coutumes et
                            modernité. Considérée comme « la Perle de l’Orient », la région administrative spéciale de la Chine représente 
